...
<html>
  ...
  <body>
    ...
    <?php
      ...
      //執行 SQL 命令
      $sql = "SELECT * FROM food WHERE 食品分類 = '魚貝類'";
...
//		echo "<td>" . $row["葉酸-成分值(ug)"] . "</td>";
      ...
      if ($page > 1)
        echo "<a href='fishfood.php?page=". ($page - 1) . "'>上一頁</a> ";
      ...
      for ($i = 1; $i <= $total_pages; $i++)
      {
        if ($i == $page)
          ...
          echo "<a href='fishfood.php?page=$i'>$i</a> ";		
      }
			
      if ($page < $total_pages)
        echo "<a href='fishfood.php?page=". ($page + 1) . "'>下一頁</a> ";			
