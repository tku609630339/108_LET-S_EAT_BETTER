...
<html>
  ...
  <body>
    ...
    <?php
      ...
      //執行 SQL 命令
      $sql = "SELECT * FROM food WHERE 食品分類 = '油脂類' OR 食品分類 = '澱粉類' OR 食品分類 = '調味料及香辛料類' OR 食品分類 = '加工調理食品類'";
      ...
      echo "<br><table width='300' cellspacing='3'>";
...
//		echo "<td>" . $row["葉酸-成分值(ug)"] . "</td>";
      ...
      if ($page > 1)
        echo "<a href='otherfood.php?page=". ($page - 1) . "'>上一頁</a> ";
      ...
      for ($i = 1; $i <= $total_pages; $i++)
      {
        if ($i == $page)
          ...
          echo "<a href='otherfood.php?page=$i'>$i</a> ";		
      }
			
      if ($page < $total_pages)
        echo "<a href='otherfood.php?page=". ($page + 1) . "'>下一頁</a> ";			
